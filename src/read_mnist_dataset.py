#
# Модифицированный код с сайта www.kaggle.com
#
# Оригинальный код:
...
def show_MNIST_images(images, title_texts):
    """
...
if __name__ == '__main__':
    ...
    for i in range(0, 10):
        ...
        titles_2_show.append('training image [' + str(r) + '] = '\
                             + str(np.where(y_train[r] == 1)[0][0])) #!
    
    for i in range(0, 5):
        r = random.randint(1, 10000)
        images_2_show.append(x_test[r])        
        titles_2_show.append('test image [' + str(r) + '] = '\
                             + str(np.where(y_test[r] == 1)[0][0])) #!
    
    show_MNIST_images(images_2_show, titles_2_show)    
